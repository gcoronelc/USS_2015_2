...
public class HomeController {
  ...
  public @ResponseBody ProductoBeanList conProductos() {
  ...
  @RequestMapping(value = "/producto/{id}", method = RequestMethod.GET, headers = "Accept=application/xml, application/json")
  ...
  @RequestMapping(value = "/producto", method = RequestMethod.POST, headers = "Accept=application/xml, application/json")
