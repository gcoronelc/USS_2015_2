package Entidades.jsf;

import Entidades.Categoria;
import Entidades.jsf.util.JsfUtil;
import Entidades.jsf.util.PaginationHelper;
import Entidades.bean.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private Entidades.bean.CategoriaFacade ejbFacade;
